...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('whatsapp_business_accounts', function (Blueprint $table) {
            ...
            $table->string('webhook_verify_token', 512)->nullable();
            $table->string('webhook_verify_token_hash', 64)->nullable()->index();
        ...
        Schema::create('whatsapp_phone_numbers', function (Blueprint $table) {
            ...
            $table->string('name_status', 64)->nullable();
            $table->string('requested_verified_name', 128)->nullable();
            $table->string('account_mode', 32)->nullable();
            $table->timestamps();
